...
/*-----------------------------------Moveable------------------------------------------*/
	...
	public class bankController {
		...
		readonly Vector3[] positions;//初始
		readonly int to_or_from;	

		MyCharacterController[] passengerPlaner;

		public bankController(string _to_or_from) {
			positions = new Vector3[] {new Vector3(6.5F,3.5f,0), new Vector3(7.5F,3.5f,0), new Vector3(8.5F,3.5f,0), 
				new Vector3(9.5F,3.5f,0), new Vector3(10.5F,3.5f,0), new Vector3(11.5F,3.5f,0)};
	...
	public class BoatController {
		...
		public BoatController() {
			...
			from_positions = new Vector3[] { new Vector3 (4.5f, 2.5f, 0), new Vector3 (5.5f, 2.5f, 0) };
			to_positions = new Vector3[] { new Vector3 (-5.5f, 2.5f, 0), new Vector3 (-4.5f, 2.5f, 0) };
